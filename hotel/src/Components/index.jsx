                        ...
                        <div className="carousel-item active">
                            ...
                            <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div className="p-3" style={{ maxWidth: '700px' }}>
                                    ...
                                    <Link to="/room"  className="btn border-0 btn-primary py-md-3 px-md-5 me-3 animated slideInLeft relative z-[2] text-white overflow-hidden font-bold tracking-wide uppercase transition-all inline-flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 bg-gradient-to-r from-[#1351d8] to-[#9c00ff] after:absolute after:h-full after:w-0 
                                    after:bottom-0 after:right-0 after:bg-purple-800
                                     after:-z-1 after:transition-all hover:text-white 
                                     hover:after:w-full hover:after:left-0 px-3 after:duration-350 after:delay-50">Our Rooms</Link>
                                    <Link to="/room" className="btn border-0 bg-white py-md-3 px-md-5 me-3 animated slideInLeft relative z-[2]  overflow-hidden font-bold tracking-wide uppercase transition-all inline-flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2  after:absolute after:h-full after:w-0 after:bottom-0 after:right-0 after:bg-purple-800 after:-z-1 after:transition-all hover:text-white  hover:after:w-full hover:after:left-0 px-3 after:duration-350 after:delay-50">Book A Room</Link>
                                </div>
                            </div>
                        </div>
