...
export default function About() {
   ...
   useEffect(() => {
    ...
    axios.get("http://localhost:4001/room/count", {
      headers: {
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6">
                            ...
                            <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">LuxuryStay</span></h1>
                            <p class="mb-4">
                                Welcome to our Hotel Management System – a modern and user-friendly platform designed to make hotel booking and management easier than ever. From seamless reservations to smooth check-in and check-out, we provide guests with a stress-free experience.</p>
                        ...
                        <div class="col-lg-6">
                            <div class="row g-3">
                                <div class="col-6 text-end">
                                    <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src={about1} style={{ marginTop: '25%' }}
                                    />
                                </div>
                                <div class="col-6 text-start">
                                    <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src={about2} />
                                </div>
                                <div class="col-6 text-end">
                                    <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src={about3} />
                                </div>
                                <div class="col-6 text-start">
                                    <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src={about4} />
                                </div>
                            </div>
                        </div>
                    </div>
