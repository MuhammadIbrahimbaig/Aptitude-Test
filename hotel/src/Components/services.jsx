                ...
                <div className="container">
                    ...
                    <div className="row g-4">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <Link to="/services/rooms" className="service-item text-decoration-none rounded">
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <Link to="/services/food" className="service-item text-decoration-none rounded">
                                <div className="service-icon bg-transparent border rounded p-1">
                                    <div className="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                            <a class="service-item text-decoration-none rounded" href="">
